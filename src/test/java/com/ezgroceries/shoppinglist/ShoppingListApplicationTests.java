...
public class ShoppingListApplicationTests {
	...
	public void addCocktailsToShoppingListAPI() throws Exception
	{
		...
		cocktails.add(new CocktailResource(UUID.fromString("23b3d85a-3928-41c0-a533-6538a71e17c4"), "Margerita",
                "Cocktail glass",
                "Rub the rim of the glass with the lime slice to make the salt stick to it. Take care to moisten..",
                "https://www.thecocktaildb.com/images/media/drink/wpxpvu1439905379.jpg",
                        ingList1));

		cocktails.add(new CocktailResource(UUID.fromString("d615ec78-fe93-467b-8d26-5d26d8eab073"), "Blue Margerita",
                "Cocktail glass",
